    ...
    public partial class ReCreateAll : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    ADFSName = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FacilityService = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    TeaService = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ITSupport = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    BookingUserMode = table.Column<int>(type: "int", nullable: false),
                    AutoRelease = table.Column<int>(type: "int", nullable: false),
                    Disabled = table.Column<bool>(type: "bit", nullable: false),
                    DefaultBookingType = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TemplateFields = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SMTPSettings_EmailTemplates_EmailTemplateId",
                        column: x => x.EmailTemplateId,
                        principalTable: "EmailTemplates",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RoomSettingsId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_RoomTimeslot", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RoomTimeslot_RoomSettings_RoomSettingsId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    AllRooms = table.Column<bool>(type: "bit", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RoomSets", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MappingKey = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    TypeId = table.Column<int>(type: "int", nullable: true),
                    BuildingId = table.Column<int>(type: "int", nullable: true),
                    DepartmentId = table.Column<int>(type: "int", nullable: true),
                    SchoolUnitId = table.Column<int>(type: "int", nullable: true),
                    RoomSettingsId = table.Column<int>(type: "int", nullable: true),
                    RoomId = table.Column<int>(type: "int", nullable: true),
                    RoomSetId = table.Column<int>(type: "int", nullable: true),
                    Created = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    LastModified = table.Column<DateTime>(type: "datetime2", nullable: true),
                    LastModifiedBy = table.Column<string>(type: "nvarchar(max)", nullable: true)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateTimes = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BookingDetailsId = table.Column<int>(type: "int", nullable: true),
                    EquipmentLoanId = table.Column<int>(type: "int", nullable: true),
                    EquipmentLoanId1 = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Contacts_EquipmentLoans_EquipmentLoanId",
                        column: x => x.EquipmentLoanId,
                        principalTable: "EquipmentLoans",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Contacts_EquipmentLoans_EquipmentLoanId1",
                        column: x => x.EquipmentLoanId1,
                        principalTable: "EquipmentLoans",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Bookings_BookingDetailsId",
                table: "Bookings",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Contacts_EquipmentLoanId",
                table: "Contacts",
                column: "EquipmentLoanId");

            migrationBuilder.CreateIndex(
                name: "IX_Contacts_EquipmentLoanId1",
                table: "Contacts",
                column: "EquipmentLoanId1");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RoomTimeslot_RoomSettingsId",
                table: "RoomTimeslot",
                column: "RoomSettingsId");

            migrationBuilder.CreateIndex(
                name: "IX_SMTPSettings_EmailTemplateId",
                table: "SMTPSettings",
                column: "EmailTemplateId");
