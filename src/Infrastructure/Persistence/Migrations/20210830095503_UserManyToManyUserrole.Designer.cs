...
namespace booking.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20210830095503_UserManyToManyUserrole")]
    partial class UserManyToManyUserrole
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("booking.Domain.Entities.UserRoleApplicationUser", b =>
                {
                    ...
                    b.HasKey("UserRoleId", "ApplicationUserId");

                    b.HasIndex("ApplicationUserId");

                    b.ToTable("UserRoleApplicationUsers");
                });
            ...
            modelBuilder.Entity("booking.Domain.Entities.UserRoleApplicationUser", b =>
                {
                    b.HasOne("booking.Infrastructure.Identity.ApplicationUser", null)
                        .WithMany("UserRoleApplicationUser")
                        .HasForeignKey("ApplicationUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("booking.Domain.Entities.UserRole", "UserRole")
                        .WithMany()
            ...
            modelBuilder.Entity("booking.Infrastructure.Identity.ApplicationUser", b =>
                {
                    ...
                    b.Navigation("UserRoleApplicationUser");
                });
