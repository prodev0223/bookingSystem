...
export interface IBookingClient {
  ...
  create(cmd: CreateSimpleBookingCommand): Observable<number>;
  getAllViewBookRoom(
  ...
  updateSimpleBooking(cmd: UpdateSimpleBookingCommand): Observable<number>;
...
export class UserClient implements IUserClient {
  ...
  getUserInfo(): Observable<any> {
    return this.http.get(`${this.baseUrl + "/api/User/GetUserInfo"}`);
  }
